...
abstract class Admin implements AdminInterface, DomainObjectInterface
{
    ...
    public function getObjectActionMenuItems($action, $object)
    {
        ...
        if(isset($object)) {
            $items['backToList'] = array(
                'href' => $this->generateUrl('list'),
                'label' => '&larr; Back to List'
            );
    ...
    {
        if(!isset($this->entityLabel)) return $this->classnameLabel;
    ...
    public function getBatchActions()
    {
        ...
        if ($this->hasRoute('delete') && $this->isGranted('DELETE')) {
            $actions['delete'] = array(
                'label' => $this->trans('batch_delete', array(), 'SonataAdminBundle'),
